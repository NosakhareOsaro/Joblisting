<x-layout>
    <x-card class="max-w-lg p-10 mx-auto mt-24">
      <header class="text-center">
        ...
        <p class="mb-4">Edit: {{$joblisting->title}}</p>
      </header>
  
      <form method="POST" action="/joblistings/{{$joblisting->id}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-6">
        ...
        <div class="mb-6">
          ...
          <input type="text" class="w-full p-2 border border-gray-200 rounded" name="title"
            placeholder="Example: Senior Laravel Developer" value="{{$joblisting->title}}" />
        ...
        <div class="mb-6">
          ...
          <input type="text" class="w-full p-2 border border-gray-200 rounded" name="location"
            placeholder="Example: Remote, Boston MA, etc" value="{{$joblisting->location}}" />
        ...
        <div class="mb-6">
          ...
          <input type="text" class="w-full p-2 border border-gray-200 rounded" name="email" value="{{$joblisting->email}}" />
        ...
        <div class="mb-6">
          ...
          <input type="text" class="w-full p-2 border border-gray-200 rounded" name="tags"
            placeholder="Example: Laravel, Backend, Postgres, etc" value="{{$joblisting->tags}}" />
