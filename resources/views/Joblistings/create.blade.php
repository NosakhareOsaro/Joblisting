<x-layout>
    <x-card class="max-w-lg p-10 mx-auto mt-24">
      ...
      <form method="POST" action="/joblistings" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
        ...
        <div class="mb-6">
          ...
          <input type="text" class="w-full p-2 border border-gray-200 rounded" name="email" value="{{old('email')}}" />
